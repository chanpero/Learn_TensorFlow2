...
class LeNet5(Model):
    def __init__(self):
        ...
        self.c1 = Conv2D(filters=6, kernel_size=5, padding='valid', activation='sigmoid')
        self.p1 = MaxPool2D(pool_size=2, strides=2, padding='valid')

        self.c2 = Conv2D(filters=16, kernel_size=5, strides=1, padding='valid', activation='sigmoid')
        self.p2 = MaxPool2D(pool_size=2, strides=2, padding='valid')
...
checkpoint_save_path = './checkpoint/LeNet5.cpkt'
