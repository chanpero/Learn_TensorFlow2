...
class AlexNet8(Model):
    def __init__(self):
        ...
        self.p1 = MaxPool2D(pool_size=3, strides=2)

        self.c2 = Conv2D(filters=256, kernel_size=3)
        self.b2 = BatchNormalization()
        self.a2 = Activation('relu')
        self.p2 = MaxPool2D(pool_size=3, strides=2)
        ...
        self.p5 = MaxPool2D(pool_size=3, strides=2)
...
checkpoint_save_path = './checkpoint/AlexNet8.cpkt'
